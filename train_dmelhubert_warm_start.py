...
class TrainArgs:
    ...
    run_name: str = "dmelhubert-iter3-warm-start"
    ...
    train_labels_dir: str = "/workspace/data/dmelhubert-labels/iter-3/layer-13/k-100/LibriSpeech/"
    train_labels_pattern: str = "train*/**/*.pt"
    valid_dmels_dir: str = "/workspace/data/dmel/LibriSpeech"
    valid_dmels_pattern: str = "dev*/**/*.pt"
    valid_labels_dir: str = "/workspace/data/dmelhubert-labels/iter-3/layer-13/k-100/LibriSpeech/"
